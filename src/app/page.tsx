...
jstag.pageView();
      ...
      {/* Ahrefs analytics (converted to Next <Script />) */}
      <Script
        id="ahrefs-analytics"
        src="https://analytics.ahrefs.com/analytics.js"
        data-key="fBV7N6xYAcrmsoO61EvfaA"
        strategy="afterInteractive"
      />
...
//   return (
//     <main className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#2b0040] via-[#1d0030] to-[#0b0015] p-6">
//       <div className="w-full max-w-md bg-[#12001f]/70 backdrop-blur-2xl shadow-2xl rounded-2xl border border-purple-700/40 p-8">
//         {/* Brand Header */}
//         <div className="text-center mb-6">
//           <h1 className="text-4xl font-extrabold text-purple-100 tracking-tight drop-shadow-md">
//             Elite<span className="text-purple-400">Store</span>
//           </h1>
//           <p className="text-purple-300/80 text-sm mt-1">Sign in to access your account</p>
//         </div>

//         {error && (
//           <div className="text-sm text-red-300 mb-4 bg-red-950/40 border border-red-700/50 rounded-md py-2 text-center">
//             {error}
//           </div>
//         )}
...
//           <div>
//             <label className="text-sm font-medium block mb-1 text-purple-200">Email address</label>
//             <input
//               required
//               autoFocus
//               type="email"
...
//               className="w-full px-4 py-2.5 rounded-lg bg-[#1a002d]/60 border border-purple-700/40 text-purple-100 placeholder-purple-400/70 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none transition"
...
//           <div>
//             <label className="text-sm font-medium block mb-1 text-purple-200">Password</label>
//             <input
//               required
//               type="password"
//               value={password}
...
//               type="submit"
//               disabled={loading}
//               className="w-full py-2.5 text-base font-semibold bg-purple-700 hover:bg-purple-800 text-white rounded-lg transition shadow-lg hover:shadow-purple-500/30"
//             >
...
// /* ---------------- FeaturedStrip (kept as in your original) ---------------- */
// function FeaturedStrip({
//   items,
//   href = "/shop",
//   speed = 40,
...
// /* ---------------- HomePage (main, with all hooks declared up front) ---------------- */
// export default function HomePage() {
//   // hooks declared BEFORE any conditional return to keep hook order stable
//   const { addToCart } = useCart();
//   const [toastProduct, setToastProduct] = useState<Product | null>(null);
//   const [isLoggedIn, setIsLoggedIn] = useState(false); // controls login-first flow
...
//   }
//   // Optionally also validate with server:
//   (async () => {
//     try {
...
//   if (!isLoggedIn) return <LoginPanel onSuccess={() => setIsLoggedIn(true)} />;

//   // --- Authenticated / main homepage render (entire original homepage) ---
//   return (
//     <ClientLayout>
//       {/* Lytics tracking tag (after interactive) */}
//       <Script
