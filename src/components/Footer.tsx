...
export function Footer() {
  ...
  return (
    <>
      {/* ✅ Updated Lytics tracking script */}
      <Script
        id="lytics-footer"
      ...
      <footer className="border-t border-primary/10 glass-dark mt-auto">
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a
                  href="#"
                  className="p-2 rounded-lg glass border border-primary/20 hover:border-primary hover:bg-primary/10 transition-all hover-lift"
                  aria-label="Facebook"
                >
                ...
                <a
                  href="#"
                  className="p-2 rounded-lg glass border border-accent/20 hover:border-accent hover:bg-accent/10 transition-all hover-lift"
                  aria-label="Twitter"
                >
          ...
          <div className="mt-12 pt-8 border-t border-primary/10 text-center">
            <p className="text-sm text-muted-foreground">
              &copy; {currentYear}{" "}
              <span className="gradient-text font-semibold">Elite Store</span>. All rights reserved.
            </p>
